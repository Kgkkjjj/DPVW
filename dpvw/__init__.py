...
toggle and the ability to enable or disable caching.  More recent
additions provide zoom controls, history clearing, opening pages in your
default browser and a configurable starting font size, all implemented
